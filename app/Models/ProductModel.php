...
class ProductModel extends Model
{
    ...
    static public function getProduct($category_id = '', $subcategory_id = '')
    {
        ...
        'sub_category.name as sub_category_name', 'sub_category.slug as sub_category_slug')
                     ...
                     ->join('sub_category', 'sub_category.id', '=', 'product.sub_category_id');
                      ...
                      {
                         $start_price = str_replace('R', '', Request::get('start_price'));
                         $end_price = str_replace('R', '', Request::get('end_price'));

                         $return = $return->where('product.bulk_price', '>=', $start_price);
                         $return = $return->where('product.bulk_price', '<=', $end_price);
                      }
    ...
    public function getRelatedProduct($product_id, $sub_category_id)
    {
        $return = ProductModel:: select('product.*' ,'users.name as created_by_name',
        'category.name as category_name', 'category.slug as category_slug',
        'sub_category.name as sub_category_name', 'sub_category.slug as sub_category_slug')
