    ...
    <div class="header-top" >
        <div class="container" >
            <div class="header-left">
                <div class="header-dropdown" style="color: orangered; font-size: 18px; font-weight: 20px;">
                    <a href="#">Zar</a>
            ...
            <div class="header-right" style="color: orangered; font-size: 18px; font-weight: 20px;">
                <ul class="top-menu">
                    <li>
                        <a href="#">Links</a>
                        <ul>
                            <li><a href="tel:#"><i class="icon-phone"></i>Call: 021 447 4398 / 021 911 2990</a></li>
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="{{ url('') }}" class="logo">
                    <img src="{{ url('upload/product/logo.jpg') }}" alt="Gem-Shoes Logo" width="200" height="200">
                </a>
            ...
            <ul class="menu sf-arrows">
                <li class="megamenu-container active">
                    <a href="{{ url('')}}" style="color: black;" >New Arrivals</a>
                </li>
            ...
            <ul class="menu sf-arrows">
                <li class="megamenu-container active">
                    <a href="{{ url('')}}" style="color: black;" >School Shoes</a>
                </li>
            ...
            <ul class="menu sf-arrows">
                <li class="megamenu-container active">
                    <a href="{{ url('')}}" style="color: orangered;" >Sale</a>
                </li>
                    ...
                    <ul class="menu sf-arrows" >
                        <li class="megamenu-container active">
                            <a href="{{ url('')}}" style="color: black;" >Become A Reseller</a>
                        </li>
